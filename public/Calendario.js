...
function request(){
    $.get('http://localhost:3000/reservations.json').done(function( data ) {
        
        var json='[';
        for(var k=0;k<data.length;k++){
            json+='{\"date\":\"'+data[k].date+'\",\"hour\":'+data[k].hour+',\"description\":\"'+data[k].description+'\"}';
